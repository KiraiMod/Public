...
namespace KiraiMod.Modules
{
    ...
    {
        public static ConfigEntry<bool> Enabled = Plugin.Configuration.Bind("ForceClone", "Enabled", true, "Force a user to allow you to clone their avatar if it is public");
        ...
        public static bool State
        {
            set
            {
                ...
                if (value) hook = Plugin.HarmonyInstance.Patch(original, target);
                else Plugin.HarmonyInstance.Unpatch(original, hook);
            }
        }
